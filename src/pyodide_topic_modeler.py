...
class PyodideTopicModeler:
    ...
    This class implements a topic modeling pipeline optimized for in-browser
    execution. Documents are embedded using LSA (Latent Semantic Analysis),
    then clustered and analyzed to extract topic representations via TF-IDF.
    """
    ...
    def get_topic_info(self) -> pd.DataFrame:
        ...
        Returns:
            ...
            comma-separated string of the top words for that topic.
